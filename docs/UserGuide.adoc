...
_Figure 5.2.1.1 : Result display indicating that a job has been added_
...
_Figure 5.2.1.2 : Job list panel before addition of job entry_

image::addj-job-list-panel-after.PNG[width="300"]
_Figure 5.2.1.3 : Job list panel after addition of job entry_
...
_Figure 5.2.2.1 : Result display indicating that a job has been closed_
...
_Figure 5.2.2.2 : Job list panel before job is closed_

image::closej-job-list-panel-after.PNG[width="300"]
_Figure 5.2.2.3 : Job list panel after job is closed_
...
_Figure 5.2.3.1 : Result display showing feedback for remark added_
...
_Figure 5.2.8.1 : Job display panel showing a summary of the selected job_
...
_Figure 5.8.1 : Mauve Theme_

image::dark-theme.PNG[width="800"]

_Figure 5.8.2 : Dark Theme_

image::light-theme.PNG[width="800"]

_Figure 5.8.3 : Light Theme_
